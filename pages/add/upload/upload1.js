...
Page({
    ...
    getCropperImage: function () {
        this.wecropper.getCropperImage(function (o) {
            ...
            app.globalData.imgs1 = o; //这个是上传图片的关键，剪裁后的图片，添加到全局图片中
            // wx.switchTab({
            ...
            wx.uploadFile({
                ...
                success: function (res) {
                    ...
                    //do something
                    if (res) {
                        app.globalData.upload_imgs[1] = 'https://flea-1257228852.cos.ap-chengdu.myqcloud.com/' + timestamp.toString() + '.jpg'
                        wx.showToast({
                            title: '图片上传成功！',
                            duration: 1000
                        });
